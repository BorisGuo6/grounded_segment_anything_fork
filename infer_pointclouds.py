...
from grasp_visualization import load_scene_filter, load_scene_global, get_segmented_pc, cue_world_point
# whisper
# import whisper
import os
import ast
...
if __name__ == "__main__":
    ...
    _, global_pc, global_colours = load_scene_global(args.num_views)
    # load speech
    ...
    with open('/home/kelvin/GraspGen/item_prompt.txt', 'r') as f:
    ...
    scene, all_pc, colours = get_segmented_pc(global_pc, global_colours, masks_all[0])
    scene.show()
    ...
    if target_secondary != None and target_secondary != "handover":
        _, secondary_pc, _ = get_segmented_pc(global_pc, global_colours, secondary_mask)
